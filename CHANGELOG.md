...
- Add verified wheel, source archive and `SHA256SUMS` assets to every GitHub Release.

### Changed

- Distribute installable packages through GitHub Releases and version tags without requiring a PyPI project.
